...
* "AutoClose":http://www.vim.org/scripts/script.php?script_id=1849 - automatically closes and exits parens, braces, brackets, and quotes in insert mode. Press Ctrl+V (c-v) to temporarily disable mapping for the next character typed. Press <Leader>a to toggle AutoClose.
