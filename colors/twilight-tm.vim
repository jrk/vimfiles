...
let s:red = '#d08356'
let s:cyan = '#74dad9'
let s:darkgrey = '#1c1c1c' " Background
let s:grey = '#303030'
let s:lightgrey = '#605958'
let s:white = '#fdfad6'    " Foreground

if version >= 700
  hi CursorLine guibg=#262626
  hi CursorColumn guibg=#262626
  hi MatchParen guifg=black guibg=#605958 gui=bold
...
exe 'hi StatusLine     guifg='.s:lightgrey         .' guibg='.s:grey            .' gui=bold'
exe 'hi StatusLineNC   guifg='.s:lightgrey         .' guibg='.s:grey            .' gui=bold'
